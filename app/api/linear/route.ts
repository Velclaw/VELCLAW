...
import { createLinearIssue, getLinearIssues, getLinearWorkspace } from '@/lib/linear/client'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await createLinearIssue(connection.accessToken, {
      teamId: body.teamId,
