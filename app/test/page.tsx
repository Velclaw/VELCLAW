      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <section className="border border-border bg-card p-5">
          <div className="grid gap-5 md:grid-cols-3">
            <div>
              <div className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Architecture</div>
              <div className="mt-2 text-sm">Task → Executor → Review → Gate → GitHub</div>
            </div>
            <div>
