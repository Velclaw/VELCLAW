  ...
  return (
    ...
    >
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        <Link href="/console" style={{ color: '#8f96a3', textDecoration: 'none', fontSize: 13 }}>
          ← Back to Console
        </Link>
        <p style={{ marginTop: 42, color: '#6d7480', font: '10px JetBrains Mono, monospace', letterSpacing: '.13em' }}>
          WORKSPACE / SETTINGS
        </p>
        <h1 style={{ fontSize: 40, letterSpacing: '-.045em', margin: '10px 0 8px' }}>Workspace settings</h1>
        <p style={{ color: '#8f96a3', fontSize: 14, marginBottom: 30 }}>
          Configure the Velclaw workspace that powers your build and runtime lifecycle.
        </p>
