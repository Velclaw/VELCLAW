          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-6 text-muted-foreground">
                Canonical project index for the Velclaw ecosystem. Each surface keeps its own runtime and repository
                boundary while sharing one workspace lifecycle and one visual language.
              </p>
            </div>
            <Link
              href="/docs/VELCLAW-INTEGRATION-CONTRACTS"
              className="border border-border px-4 py-2 font-mono text-xs transition hover:border-primary hover:text-primary"
            >
        ...
        <section className="mt-8">
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="font-mono text-[11px] text-muted-foreground">
              {ECOSYSTEM_PROJECTS.length.toString().padStart(2, '0')} surfaces
            </span>
          </div>
