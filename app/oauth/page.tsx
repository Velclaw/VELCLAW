...
function OAuthError({ message }: { message: string }) { return <main className="min-h-screen bg-[#050608] text-white flex items-center justify-center px-5"><div className="max-w-md rounded-3xl border border-red-400/20 bg-red-400/[.04] p-8"><Brand /><h1 className="mt-8 text-xl font-semibold">OAuth request rejected</h1><p className="mt-3 text-sm leading-6 text-white/60">{message}</p></div></main> }
