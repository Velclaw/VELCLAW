...
export const AiDevopsDoctor: React.FC<AiDevopsDoctorProps> = ({ project, initialLogText = '' }) => {
          ...
          <div className="mt-5 space-y-4">
            <form onSubmit={handleDesignArchitecture} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1">Mô tả dự án & yêu cầu</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1">Tech Stack & Frameworks</label>
                  <input
                    type="text"
                    value={techStack}
