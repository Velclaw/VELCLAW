      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <header className="border border-border bg-card p-5">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            MCP là lớp mở rộng trực tiếp cho Agent → Executor: server cung cấp tools/resources/prompts để task có thêm
            khả năng mà không phải nhúng provider-specific logic vào core.
          </p>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="text-xs text-muted-foreground">
              Task schema đã có MCP server IDs và executor hiện nhận danh sách server khi task chạy.
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
