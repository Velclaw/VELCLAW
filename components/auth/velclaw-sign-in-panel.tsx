  ...
  return (
    <div className={compact ? 'w-full' : 'w-full max-w-md'}>
      ...
      <div className="mt-6 flex items-start gap-3 border border-border/70 bg-muted/20 p-3 text-xs leading-5 text-muted-foreground">
        ...
        <span>
          GitHub là phương thức đăng nhập production hiện đã được nối với Velclaw Identity. Google và ChatGPT chỉ bật
          sau khi callback OAuth tương ứng được cấu hình.
        </span>
      </div>
