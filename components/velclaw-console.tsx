    ...
    <main className={styles.page}>
      <header className={styles.topbar}>
        ...
        <div className={styles.topActions}>
          <button className={styles.searchButton} aria-label="Search workspace">
            <Search size={16} />
            <span>Search</span>
            <kbd>⌘ K</kbd>
          </button>
          ...
          <div className={styles.avatar} aria-label="Velclaw workspace">
            V
          </div>
        </div>
      </header>
        ...
        <aside className={styles.sidebar}>
          <div className={styles.sidebarTop}>
            ...
            <span className={styles.online}>
              <CircleDot size={10} /> <span>Online</span>
            </span>
          </div>
          ...
          <div className={styles.sidebarFooter}>
            <Link href="/hosting">
              <Layers3 size={16} /> <span>Environments</span>
            </Link>
            <Link href="/settings">
              <Settings2 size={16} /> <span>Workspace settings</span>
            </Link>
          </div>
        </aside>
        ...
        <section className={styles.content}>
          <div className={styles.pageHeader}>
            ...
            <div className={styles.headerActions}>
              <Link className={styles.secondary} href="/repos/Velclaw/VELCLAW">
                <Search size={15} /> Find project
              </Link>
              <Link className={styles.primary} href="/builder">
          ...
          <div className={styles.mainGrid}>
            <section className={styles.panel}>
              <div className={styles.panelHeader}>
                <div>
                  <span className={styles.panelKicker}>PROJECTS</span>
                  <h2>Active work</h2>
                </div>
                <Link href="/repos/Velclaw/VELCLAW">
                ...
                {projects.map((project) => (
                  <Link href={project.href} className={styles.projectRow} key={project.name}>
                    ...
                    <div className={styles.projectInfo}>
                      ...
                      <span>
                        <GitBranch size={12} /> {project.repo}
                      </span>
                    </div>
                    <div className={styles.projectState}>
                      <span className={project.state === 'Building' ? styles.building : styles.healthy}>
                        {project.state}
                      </span>
            ...
            <section className={styles.panel}>
              ...
              <div className={styles.runtime}>
                <div className={styles.runtimeRing}>
                  <span>98%</span>
                </div>
                <div>
                  <strong>All systems operational</strong>
                  <p>Agents, builds and deployment workers are responding normally.</p>
                </div>
              </div>
          ...
          <section className={styles.panel}>
            <div className={styles.panelHeader}>
              <div>
                <span className={styles.panelKicker}>ACTIVITY</span>
